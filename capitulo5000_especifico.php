...
setTimeout('open("capitulo5000.php");,5000');
...
<table width="98%" border="0">
    <tr>
      <th width="19%" height="38">Seleccione el departamento:</th>
      <th width="20%">
...
if(isset($_POST['combo']) && $_POST['combo']!='')
{
	...
	$Sql="SELECT * FROM capitulo5000 WHERE clave_departamento = '$clavesesion'";
	$ISql = mysql_query($Sql);
...
<link href="greybox/gb_styles.css" rel="stylesheet" type="text/css" />
						...
						<span class="txtcontenidoazul">Capitulo 5000 por departamento</span><!-- InstanceEndEditable -->
</body>
