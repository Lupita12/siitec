...
<table width="98%" border="0">
    <tr>
      <th width="19%" height="38">Seleccione la partida:</th>
      <th width="20%">
...
if(isset($_POST['combo']) && $_POST['combo']!='')
{
	...
	$Sql="SELECT * FROM capitulo5000 WHERE clave_partida = '$clavesesion'";
	$ISql = mysql_query($Sql);
...
<link href="greybox/gb_styles.css" rel="stylesheet" type="text/css" />
						...
						<span class="txtcontenidoazul">Capitulo 5000 por partida</span><!-- InstanceEndEditable -->
</body>
