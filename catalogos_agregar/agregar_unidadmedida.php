...
<form id="form1" name="form1" method="post" action="">
  <table width="548" border="0" align="center">
    <tr>
      <td colspan="2" align="center">AGREGAR UNIDAD DE MEDIDA</td>
    </tr>
    <tr>
...
if(isset($_POST['txtclave']) && $_POST['txtclave']!='')
{
	...
	$Sql="SELECT * FROM unidadmedida WHERE clave= $clave OR descripcion= '$descripcion'";
	...
	else
	{
		...
		$UnidadMedida->agregarUnidadMedida();
