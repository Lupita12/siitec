  ...
  <table width="850" border="0" align="center">
    <tr>
      <td colspan="4"><table width="100%" border="0">
        <tr>
          <td width="76%">&nbsp;</td>
          <td width="3%"><a href="../catalogos_agregar/agregar_tipoarticulo.php" title="Agregar Tipo Articulo" rel="gb_page_center[740,250]"><img src="../imagenes/add.png" width="18" height="18" alt="Agregar" border="0" /></a></td>
          <th width="21%">Agregar Tipo de Articulo</th>
        </tr>
      </table></td>
    </tr>
    <tr>
      <th width="67">Clave</th>
      <th width="252">Descripcion</th>
...
//JALA TODOS LOS DATOS PARA PODER IMPRIMIR EN LA TABLA Y PODER MANDAR ID_ALTADIRECCION A LA PAGINA ASIGNAR_META Y MODIFICAR ALTADIRECCION
	...
	$Sql="SELECT * FROM tipoarticulo order by clave";
	$ISql = mysql_query($Sql);
	$row = mysql_fetch_array($ISql);
	...
	if($num>0)
	{
		...
		{ 
			...
			<? $a=0;}?>
      			<td><?=$row[0];?></td>
		      	<td><?=$row[1];?></td>
      			<td align="center"><a href="../catalogos_modificar/modificar_tipoarticulo.php?clav=<?=$row[0]; ?>" title="Modificar Tipo Articulo" rel="gb_page_center[740,250]"><img src="../imagenes/ico_edit.gif" width="15" height="17" border="0"/></a></td>
...
?>
						...
						<span class="txtcontenidoazul">Tipo Articulo</span>
...
{
	if(window.confirm('DESEA ELIMINAR UN TIPO ARTICULO?'))
	{
		var campos = '&elimina='+elim; 
		open('../catalogos_eliminar/eliminar_tipoarticulo.php?id='+campos,'_self');
	}
}
</script>
