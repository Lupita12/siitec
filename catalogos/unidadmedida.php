  ...
  <table width="850" border="0" align="center">
    <tr>
      <td colspan="5"><table width="100%" border="0">
        <tr>
          <td width="76%">&nbsp;</td>
          <td width="3%"><a href="../catalogos_agregar/agregar_unidadmedida.php" title="Agregar Unidad de Medida" rel="gb_page_center[740,250]"><img src="../imagenes/add.png" width="18" height="18" alt="Agregar" border="0" /></a></td>
          <th width="21%">Agregar Marca</th>
        </tr>
      </table></td>
    </tr>
    <tr>
...
//JALA TODOS LOS DATOS PARA PODER IMPRIMIR EN LA TABLA Y PODER MANDAR ID_ALTADIRECCION A LA PAGINA ASIGNAR_META Y MODIFICAR ALTADIRECCION
	$Sql="SELECT * FROM unidadmedida order by clave";
	...
	if($num>0)
	{
		...
		{ 
			...
			<? $a=0;}?>
		      	...
		      	<td><?=$row[1];?></td>
      			<td><?=$row[2];?></td>
      			<td align="center"><a href="../catalogos_modificar/modificar_unidadmedida.php?idd=<?=$row[0]; ?>" title="Modificar Unidad de Medida" rel="gb_page_center[740,250]"><img src="../imagenes/ico_edit.gif" width="15" height="17" border="0"/></a></td>
...
?>
						...
						<span class="txtcontenidoazul">Unidad de Medida</span>
...
function eliminar(elim)
{
	if(window.confirm('DESEA ELIMINAR LA UNIDAD DE MEDIDA?'))
	{
		...
		open('../catalogos_eliminar/eliminar_unidadmedida.php?id='+campos,'_self');
	}
}
</script>
