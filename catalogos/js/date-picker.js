...
Calendar.prototype.show = function() {
	...
	this.wwriteA("<FONT FACE='" + fontface + "' SIZE=2><div align='center'><B>");
	...
	this.wwrite("<FONT FACE='" + fontface + "' SIZE=2><div align='center'><B>"+"[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)-1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><<<\/A>]"+"</B></div>"+"</TD><TD ALIGN=center>");
	this.wwrite("<FONT FACE='" + fontface + "' SIZE=2><div align='center'><B>"+"[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
	...
	this.wwrite("<FONT FACE='" + fontface + "' SIZE=2><div align='center'><B>"+"[<A HREF=\"" +"javascript:window.opener.Build(" +"'" + this.gReturnItem + "', '" + nextMM + "', '" + nextYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\">><\/A>]"+"</B></div>"+"</TD><TD ALIGN=center>");
	this.wwrite("<FONT FACE='" + fontface + "' SIZE=2><div align='center'><B>"+"[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
...
Calendar.prototype.showY = function() {
	...
	this.wwrite("[<A HREF=\"javascript:window.print();\">Pint</A>]</TD><TD ALIGN=center>");
	this.wwrite("[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
...
function show_calendar() {
	...
	*/
	...
	vWinCal = window.open("", "Calendario", 
		"width=180,height=210,status=no,resizable=no,top=200,left=200");
	vWinCal.opener = self;
	ggWinCal = vWinCal;
