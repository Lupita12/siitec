...
<form id="form1" name="form1" method="post" action="">
  <table width="89%" border="0" align="center">
    <tr>
      <th width="186">Vigencia</th>
      <th width="192">Monto</th>
      <th width="70">Modificar</th>
    </tr>
<?PHP
	//REALIZAS LA CONSULTA SQL PARA OBTENER LOS DATOS SOLICITADOS 
	$Sql="SELECT clave,DATE_FORMAT(vigencia,'%d/%m/%Y') as vigencia,monto,periodo FROM presupuestoinicial";
	...
	if($num>0)
	{
		...
		{ 
			...
			<? $a=0;}?>
      			...
      			<td align="center"><a href="modificar_presupuestoinicial.php?idd=<?=$row[0]; ?>" title="Modificar Presupuesto Inicial" rel="gb_page_center[740,350]"><img src="imagenes/ico_edit.gif" width="15" height="17" border="0"/></a></td>
   			</tr>     
<? 
		} 
	} 
...
<link href="greybox/gb_styles.css" rel="stylesheet" type="text/css" />
						...
						<span class="txtcontenidoazul">Presupuesto Inicial</span><!-- InstanceEndEditable -->
</body>
