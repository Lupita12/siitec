...
<p>Exportar a Excel  <img src="imagenes/Excel.png" class="botonExcel" height="25px" width="25px" style="cursor:pointer" onclick="javascript:imprimir()" /></p>
