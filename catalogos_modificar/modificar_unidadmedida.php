<? session_start(); ?>
<? include("../clases/cls_unidadmedida.php"); ?>
...
<?
$clave=$_GET['idd'];
$UnidadMedida1 = new UnidadMedida($clave);
?>
  <table width="548" border="0" align="center">
    <tr>
      <td colspan="2" align="center">MODIFICAR UNIDAD DE MEDIDA</td>
    </tr>
    <tr>
      <td width="98" align="right">Clave:</td>
      <td width="440"><input type="text" name="txtclave" id="txtclave" onkeypress="return decimales(event,this);" value="<?=$UnidadMedida1->getclave(); ?>"/></td>
    </tr>
    <tr>
      <td align="right">Nombre:</td>
      <td><input type="text" name="txtnombre" id="txtnombre" value="<?=$UnidadMedida1->getnombre(); ?>" /></td>
    </tr>
    <tr>
      <td align="right">Descripcion:</td>
      <td><textarea name="txtdescripcion" cols="70" id="txtdescripcion"><?=$UnidadMedida1->getdescripcion(); ?></textarea></td>
    </tr>
    <tr>
...
if(isset($_POST['txtclave']) && $_POST['txtclave']!='')
{
	...
	$Sql="SELECT * FROM unidadmedida WHERE clave= '$clave'";
	...
	if($num>0)
	{
		...
		if($clave==$idd)
		{
				if($_POST['txtclave']!=0)
				{
					$UnidadMedida = new UnidadMedida($idd);
					$UnidadMedida->setclave($clave);
					$UnidadMedida->setnombre($nombre);
					$UnidadMedida->setdescripcion($descripcion);
					$UnidadMedida->modificarUnidadMedida();
