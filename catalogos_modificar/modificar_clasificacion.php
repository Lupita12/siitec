<? session_start(); ?>
<? include("../clases/cls_clasificacion.php"); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>MODIFICAR CLASIFICACION</title>
</head>
...
<?
$clave=$_GET['idd'];
$Clasificacion1 = new Clasificacion($clave);
?>
  <table width="548" border="0" align="center">
    <tr>
      <td colspan="2" align="center">MODIFICAR CLASIFICACION</td>
    </tr>
    <tr>
      <td width="98" align="right">Clave:</td>
      <td width="440"><input type="text" name="txtclave" id="txtclave" onkeypress="return decimales(event,this);" value="<?=$Clasificacion1->getclave(); ?>"/></td>
    </tr>
    <tr>
      <td align="right">Nombre:</td>
      <td><input type="text" name="txtnombre" id="txtnombre" value="<?=$Clasificacion1->getnombre(); ?>" /></td>
    </tr>
    <tr>
      <td align="right">Descripcion:</td>
      <td><textarea name="txtdescripcion" cols="70" id="txtdescripcion"><?=$Clasificacion1->getdescripcion(); ?></textarea></td>
    </tr>
    <tr>
...
if(isset($_POST['txtclave']) && $_POST['txtclave']!='')
{
	...
	$Sql="SELECT * FROM clasificacion WHERE clave= '$clave'";
	...
	if($num>0)
	{
		...
		if($clave==$idd)
		{
				if($_POST['txtclave']!=0)
				{
					$Clasificacion = new Clasificacion($idd);
