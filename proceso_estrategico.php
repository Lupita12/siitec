...
setTimeout('open("proceso_estrategico.php");,5000');
...
{
	if(confirm('¿Esta seguro de eliminar el proceso estrategico?'))
	{
	
	var campos = '&elimina='+elim; 
	open('eliminar_procesoestrategico_cascada.php?id='+campos,'_self');
...
<form id="form1" name="form1" method="post" action="">
  <table width="850" border="0" align="center">
    <tr>
      <td colspan="7"><table width="107%" border="0">
        <tr>
          <td width="76%">&nbsp;</td>
          <td width="9%"><a href="agregar_procesoestrategico.php" title="Agregar Proceso Estrategico" rel="gb_page_center[740,500]"><img src="images/add.png" width="18" height="18" alt="Agregar"  border="0"/></a></td>
          <td width="15%">Agregar Proceso</td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td width="71">Clave</td>
      <td width="165">Nombre</td>
      <td width="101">Descripcion</td>
     
      <td width="85">Monto</td>
      <td width="87">Periodo</td>
      <td width="74">Modificar</td>
      <td width="44">Eliminar</td>
    </tr>
<?PHP
	//REALIZAS LA CONSULTA SQL PARA OBTENER LOS DATOS SOLICITADOS 
	$Sql="SELECT * FROM procesoestrategico";
		...
		?>  
			...
			<? $a=0;}?>
                ...
                <td><? echo $row[5]; ?></td>
      			...
      			<td align="center"><a href="modificar_proceso_estrategico.php?idd=<?=$row[0]; ?>" title="Modificar Proceso Estrategico" rel="gb_page_center[740,500]"><img src="imagenes/ico_edit.gif" width="15" height="17" border="0"/></a></td>
...
<title>Administrador de contenidos web - Tecnológico de Colima</title>
						...
						<span class="txtcontenidoazul">Proceso Estrategico</span><!-- InstanceEndEditable -->
</body>
