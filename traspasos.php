  ...
  <table width="850" border="0" align="center">
    <tr>
      <td colspan="7"><table width="100%" border="0">
        <tr>
          <td width="76%">&nbsp;</td>
          <td width="3%"><a href="agregar_traspasos.php" title="Agregar Traspaso" rel="gb_page_center[740,250]"><img src="images/add.png" width="18" height="18" alt="Agregar"  border="0"/></a></td>
          <td width="21%">Agregar Traspaso</td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td width="81">Clave Departamento</td>
      <td width="81">Clave Requisicion</td>
      <td width="81">Clave Meta</td>
      <td width="81">Clave Partida</td>     
	...
	if($num>0)
	{
		...
		?>  
			...
			<? $a=0;}?>
      			...
      			<td align="center"><div align="center"><a href="modificar_traspasos.php?idd=<?=$row[0]; ?>" title="Modificar Traspaso" rel="gb_page_center[740,250]"><img src="imagenes/ico_edit.gif" width="15" height="17" border="0"/></a></div></td>
